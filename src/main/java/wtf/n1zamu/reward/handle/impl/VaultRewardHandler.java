...
public class VaultRewardHandler implements RewardHandler {
    ...
    public void reward(Player player, CrateItem prize) {
        ...
        VaultHook.getEconomy().depositPlayer(player, fromString(prize.getTitle()));
    }

    private double fromString(String input) {
